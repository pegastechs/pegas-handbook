...
At Pegas Technology Solutions, we’re trying to build an inclusive and value-driven organization, so you’ll find that a lot of our policies differ from the norm at other companies. If you have any questions about why we do things a certain way, or have a suggestion about how we can do anything better, please let us know (or just write comments in the documents -- you should already have comment access to everything in the Pegas Technology Solutions handbook!).  

## Your First Day

Hopefully by the time you’re actually starting at Pegas Technology Solutions, you’ve already finished filling out the paperwork and you’ve showed up to a desk with a new computer and the accessories that fit your work-style. Today is all about getting you set up and making sure you’re ready to go.

**The goal for today is for you to publish _something_ live.** If you’re a designer, that could be a color change for a button. If you’re a developer, it might be fixing a missing semicolon. It could be a tweet from the Pegas Technology Solutions account or a blog post, a support response or an infographic. Whatever you’ll be doing at Pegas Technology Solutions, we want you to ship something small today.
...
## The Basics about Pegas Technology Solutions

**Pegas Technology Solutions is a values-driven company.** Hopefully you heard about this a lot during your interview process, but we take our values really seriously at Pegas Technology Solutions and they guide the decisions we make here. You can read more about the [Pegas Technology Solutions Values](https://github.com/pegastechs/pegas-handbook/blob/master/Values.md), but the short versions are:
...
**Pegas Technology Solutions isn’t a normal security company.** Security is traditionally a very technical and inaccessible field. At Pegas Technology Solutions, we’re working to make security easy and approachable to everyone, and that radiates through everything we do. Our product is meant to be friendly and fun, and our attitude should never feel superior or smug. Pegas Technology Solutions isn’t about protecting people, it’s about empowering them.
...
## The Pegas Technology Solutions Team, Hours, and Office

For now, Pegas Technology Solutions operates as a single team where everyone is working towards company-level goals. Since we’re still small, there’s not too much overhead in keeping up with everyone. There are still engineering-specific meetings, and marketing conversations that happen separately. But when we set our goals, we all think directly about how we contribute to the company goals. You’ll get to work with everyone at Pegas Technology Solutions in some capacity, and dip your fingers into all different kinds of thinking.
...
You should expect a typical workweek at Pegas Technology Solutions to be 45-50 hours. Most people show up between 9 and 10 and leave between 6 and 7. We don’t work weekends, but a lot of us host or go to events at night. This is to give you a sense of what’s normal here, but you should work the hours that are healthy and sustainable for you.
...
Pegas Technology Solutions is a small company that is changing and improving rapidly. Today is about welcoming you and helping you join our team, but soon we’ll need your help growing and learning. Pegas Technology Solutions will be a very different company a year from today, and it’s hard to imagine what it will be like in 5 or 10. You will have a hand in building that company, and we’re so excited to have your help.
